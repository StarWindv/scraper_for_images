...
from utils.change_text import parse_text
...
def stv_parse():
    ...
    parser.add_argument('-p', '--page', type=int, help=help_text[1])
    ...
    parser.add_argument('--license', action='store_true', help=help_text[7])
