def parse_text():
    ...
    if is_ch():
        ...
        path_help = '修改默认输出路径'
        license_help = '查看本项目所用的许可证'
        version_help = '查看项目版本号'
        ...
        path_help = 'Modify default output path'
        license_help = 'Output the licenses used'
        version_help = 'Project Version'

    help_text = [key_world_help, page_help, remove_help, window_help,
                 lines_help, time_less_help, plate_help, path_help,
